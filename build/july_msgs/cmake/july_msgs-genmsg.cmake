...
message(STATUS "july_msgs: 1 messages, 0 services")

set(MSG_I_FLAGS "-Ijuly_msgs:/home/parallels/catkin_ws/src/july_msgs/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/parallels/catkin_ws/src/july_msgs/msg/JulyMsg.msg" NAME_WE)
add_custom_target(_july_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "july_msgs" "/home/parallels/catkin_ws/src/july_msgs/msg/JulyMsg.msg" ""
)
...
_generate_msg_cpp(july_msgs
  "/home/parallels/catkin_ws/src/july_msgs/msg/JulyMsg.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/july_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/july_msgs\")")
  # install generated code
  install(
